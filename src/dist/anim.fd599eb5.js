...
// Index animation
var tl = new TimelineLite();
tl.fromTo('.section-1', 0.7, {
  height: '10vh',
  ease: _gsap.Power2.easeOut
}, {
  height: '100vh'
}).fromTo('.section-2', 0.7, {
  height: '10vh',
  ease: _gsap.Power2.easeOut
}, {
  height: '100vh'
}, '-=0.7').fromTo('.section-3', 0.7, {
  height: '10vh',
  ease: _gsap.Power2.easeOut
}, {
  height: '100vh'
}, '-=0.7').fromTo('.front-link', 0.7, {
  opacity: '0',
  x: '70',
  ease: _gsap.Power2.easeOut
}, {
  opacity: '1',
  x: '0'
}, '-=0.4'); // London Animation

var tl1 = new TimelineLite();
tl1.fromTo('.half-image', 0.6, {
  width: '33vw',
  ease: _gsap.Power2.easeOut
}, {
  width: '50vw'
}).fromTo('.half-image', 0.6, {
  opacity: '0.5',
  ease: _gsap.Power2.easeOut
}, {
  opacity: '1'
}, '-=0.3').fromTo('.socials', 0.4, {
  opacity: '0',
  x: '-50',
  ease: _gsap.Power2.easeOut
}, {
  opacity: '1',
  x: '0'
}, '-=0.5').fromTo('.description-text', 0.4, {
  opacity: '0',
  x: '-50',
  ease: _gsap.Power2.easeOut
}, {
  ...
  opacity: '1',
  y: '0'
}, '-=0.4'); // istanbul animation

var tl2 = new TimelineLite();
tl2.fromTo('.image-third', 0.5, {
  y: '-1500',
  ease: _gsap.Power2.easeOut
}, {
  y: '0'
}).fromTo('.image-third', 0.5, {
  width: '2vw',
  ease: _gsap.Power2.easeOut
}, {
  width: '40vw'
}, '-=0.2').fromTo('.image-third', 0.7, {
  opacity: '0.5',
  ease: _gsap.Power2.easeOut
}, {
  opacity: '1'
}, '-=0.5').fromTo('.socials-istanbul', 0.4, {
  opacity: '0',
  x: '-50',
  ease: _gsap.Power2.easeOut
}, {
  ...
  opacity: '1',
  x: '0'
}, '-=0.4').fromTo('.back-button-istanbul', 0.4, {
  opacity: '0',
  y: '-50',
  ease: _gsap.Power2.easeOut
}, {
  ...
  opacity: '1',
  y: '0'
}, '-=0.4'); // taipei animation

var tl3 = new TimelineLite();
tl3.fromTo('.taipei-half-image', 0.5, {
  y: '-500',
  ease: _gsap.Power2.easeOut
}, {
  y: '0'
...
},{}]},{},["../../../../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","js/anim.js"], null)
//# sourceMappingURL=/anim.fd599eb5.js.map